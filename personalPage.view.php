    ...
    <div class="container">
        ...
        '. Beginning on ' . $campDates['Start_Date'].' till '.$campDates['End_Date'].'.'; }?>
                ...
                <div id="toDoList">
                    ...
                    <p class="personalPage">The Game Convention will take place this July.
                        You have the option to pay the entrance fee at the event venue on the day of the event.
                        However you also have the option of paying before the
                    event date and  using our limited 5€ offer! So click on the link below to take advantage
                    ...
                    <p class="personalPage">  
                        For those of you planning to spend the week at the festival, you and
                         five other friends have the option of renting a campsite on the festival grounds. In order
                        to sign up your friends for the camp-site they must already be  registered for the festival
