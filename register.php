              ...
              if(empty($_POST) === false && empty($errors) === true){
                //register user
                  ...
                  if($EventData->insert())
                  {
                       ...
                       $msg = "<p>Hello ".$register_data['lastname'].",<\p> <p>You need to activate your account, please click the link below: <\p> <p>".$link."<\p> <p> Kind regards,</p> <p>Dream Battle team</p>";
                       $subject = "Activate Dream Battle Game Convention event";
